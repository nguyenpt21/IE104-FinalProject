...
export default function ProfileCard(props) {
  return (
    <div className="relative w-[350px] h-[160px] bg-white rounded-2xl shadow-custom duration-500 hover:h-[230px] group">
      <div className="absolute left-1/2 -top-[50px] -translate-x-2/4 shadow-custom rounded-2xl">
        <Image
          className="rounded-2xl group-hover:w-[200px]  transition-all duration-500"
          src={props.img}
          width={150}
          height={150}
